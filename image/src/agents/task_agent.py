...
- Se o prioridade não for especificada, considere como mais urgente possível
...
class Task(BaseModel):
    ...
    priority: Literal[1, 2, 3, 4] = Field(description='Prioridade da tarefa. Quanto menor, mais urgente')
